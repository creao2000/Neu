...
def add_management_information_systems_curriculum_to_chromadb():
    """Add Management Information Systems curriculum data to ChromaDB"""
    ...
    try:
        collection = chroma_client.get_collection(
            name="neu_management_information_systems",
        ...
        print("Created new collection: neu_management_information_systems")
...
TE, TECHNICAL ELECTIVE 1, T: 2, P: 2, C: 3, E: 4
TE, TECHNICAL ELECTIVE 2, T: 2, P: 2, C: 3, E: 4
TE, TECHNICAL ELECTIVE 3, T: 2, P: 2, C: 3, E: 4
...
TE, TECHNICAL ELECTIVE 4, T: 2, P: 2, C: 3, E: 6
TE, TECHNICAL ELECTIVE 5, T: 2, P: 2, C: 3, E: 4
TE, TECHNICAL ELECTIVE 6, T: 2, P: 2, C: 3, E: 4
TE, TECHNICAL ELECTIVE 7, T: 2, P: 2, C: 3, E: 4
...
CIS491, DIGITAL TRANSFORMATION FOR SUSTAINABLE BUSINESSES, T: 2, P: 2, C: 3, E: 4""",
        ...
        # Program Summary
        """Management Information Systems Program Summary:
...
Key Features:
- Combines business management with information technology
- Focus on practical programming and system development skills
- Emphasis on business applications of information systems
- Strong foundation in economics, statistics, and management""",
...
1. Apply business and management principles to information systems contexts
2. Analyze, design, and implement information systems solutions
3. Develop software applications using modern programming techniques
4. Manage database systems and information resources effectively
5. Understand e-business systems and digital transformation strategies
6. Apply project management principles to IT projects
7. Analyze ethical and social issues in information systems
8. Communicate effectively in business and technical contexts
9. Apply statistical methods to business decision-making
10. Develop web-based applications and e-business solutions"""
    ]
    ...
    ids = [f"mis_curriculum_{i:03d}" for i in range(len(documents))]
    ...
    try:
        ...
        print(f"Successfully added {len(documents)} Management Information Systems curriculum documents to ChromaDB!")
        ...
        test_results = collection.query(
            query_texts=["management information systems business technology"],
            n_results=3
        )
...
if __name__ == "__main__":
    add_management_information_systems_curriculum_to_chromadb()